...
export const glossary = {
  ...
  // ────────────── Chapter 18 — The PID structure theorem ──────────────
  primeElement: {
    term: 'Prime element',
    symbol: 'p \\in R',
    definition: 'In a UFD R, a nonzero non-unit element p such that the principal ideal (p) is a prime ideal. Equivalently: whenever p = xy then x or y is a unit. This generalises the usual prime numbers in ℤ.',
    example: 'In ℤ the prime elements are ±2, ±3, ±5, … In ℤ[i] the element 2 + i is prime.',
  },
  divides: {
    term: 'Divides',
    symbol: 'r \\mid s',
    definition: 'An element r divides s in a ring R if s = r′r for some r′ ∈ R. Equivalently, s ∈ (r), the principal ideal generated by r. For integers this matches the usual notion.',
    example: '3 ∣ 12 in ℤ because 12 = 4·3. In ℤ[x], x ∣ x²+x because x²+x = (x+1)·x.',
  },
  noetherianModule: {
    term: 'Noetherian module',
    symbol: 'M',
  ...
  abelianGroup: {
    term: 'Abelian group',
    symbol: '(G, +)',
    definition: 'A group whose operation is commutative: a + b = b + a for all elements a, b. Abelian groups are the same as ℤ-modules. Every subgroup of an abelian group is normal.',
    example: '(ℤ, +), (ℝ, +), and ℤ/nℤ are all abelian groups. The symmetric group S₃ is not abelian.',
  },
  ZZmodule: {
    term: 'ℤ-module',
    symbol: 'M',
    definition: 'A module over the ring ℤ of integers. Since every integer n acts on an abelian group G by n·g = g + g + ⋯ + g (n times), every abelian group is naturally a ℤ-module, and conversely every ℤ-module is an abelian group.',
    example: 'ℤ/nℤ is a ℤ-module of rank 0. ℤ² is a free ℤ-module of rank 2.',
  },
  fgAbelian: {
    term: 'Finitely generated abelian group',
    symbol: 'G = \\langle b_1, \\dots, b_m \\rangle',
    definition: 'An abelian group G that has a finite generating set: elements b₁, …, bₘ such that every element of G is an integer linear combination c₁b₁ + ⋯ + cₘbₘ. Equivalently, G is finitely generated as a ℤ-module.',
    example: 'ℤ is generated by {1}. ℤ/nℤ is generated by {1}. ℤ² is generated by {(1,0),(0,1)}.',
  },
  abelianRank: {
    term: 'Rank (abelian group)',
    symbol: 'r',
